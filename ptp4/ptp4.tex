...
\title{PTP4 \"Ubersicht \\ Theoretische Quantenmechanik \\ Professor Matthias Bartelmann}
...
Drehimpulse: 
\begin{itemize}
\item $ J^2 \ket{j, j_3} = \hbar^2j(j+1) \ket{j, j_3} $
\item $ J_3 \ket{j, j_3} = \hbar j_3 \ket{j, j_3} $
\item $ J_{\pm} \ket{j, j_3} = \hbar \sqrt{j(j+1)-j_3(j_3 \pm 1)} \ket{j, j_3 \pm 1} $
\end{itemize}
